...
const Accessibility = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      announceOnLoad(
        "Accessibility features page. PathFinder AI is designed for voice-first interaction and full screen reader support."
      );
    }, 500);
  ...
  return (
    <Layout>
      ...
      <div className="px-6 py-10">
        ...
        <section className="mx-auto mt-10 max-w-lg rounded-xl bg-secondary p-6">
